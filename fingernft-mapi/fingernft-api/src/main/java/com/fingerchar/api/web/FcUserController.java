...
public class FcUserController extends BaseController {
  ...
  private final FcNftItemsService nftItemsService;
  private final FcSystemConfigManager systemConfigManager;
  private final FcUserFollowManager followManager;
  private final FcUserTokenService userTokenService;
  ...
  public Object login(String userAddress, String signature, Long timestamp) {
    ...
    // token
    String token = UserTokenManager.generateToken(user.getAddress(), fingerProperties.getTokenSecret());
