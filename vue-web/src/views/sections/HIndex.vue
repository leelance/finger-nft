  ...
  <div class="body-wrapper">
    ...
    <div class="home-wrapper main-wrapper">
      ...
      <div class="search-options justify-between">
        ...
        <div class="nft-sorts">
          <div class="nft-sorts-item" :class="sortKey == 'update_time' ? 'active' : ''"
    ...
    <cancel-sale-dialog :show="showCancelSaleDialog" @close="closeDialog" @confirm="dialogConfirm" :asset="dialogOrder"
      :nft="dialogNft" :uri="dialogNftURI">
    </cancel-sale-dialog>
    ...
    <bid-dialog :show="showBidDialog" @close="closeDialog" @confirm="dialogConfirm" :bid="dialogOrder" :nft="dialogNft"
      :uri="dialogNftURI">
    </bid-dialog>
...
export default {
  ...
  data: function () {
    return {
      banner: import("@/assets/img/home/index_bg.png"),
      sortKey: "",
      filterId: "",
      filters: [],
      sortValue: "",
