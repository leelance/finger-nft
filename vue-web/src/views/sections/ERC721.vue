          ...
          <div class="collection-left">
            ...
            <el-form :model="createForm" class="create-form" label-position="top">
              <el-form-item :class="['upload-file', { err: errorForm.file }]">
                ...
                <el-upload ref="uploadFile" class="upload-pic" v-if="!tempImg && !temAnim" :accept="$tools.mediaType()"
                  action="" :limit="1" :auto-upload="false" :on-change="(file, fileList) => {
              ...
              <el-form-item :class="['upload-file', { err: errorForm.file }]" v-if="temAnim">
                ...
                <el-upload ref="coverFile" class="upload-pic" v-if="temAnim && !tempImg" :accept="$tools.imageType()"
              ...
              <el-form-item :class="['put-on-sale', { err: errorForm.price }]">
                ...
                <el-input class="input-with-select" v-if="createForm.onSale" type="number" placeholder="0.0" :min="0"
              ...
              <el-form-item class="choose-collection">
                ...
                <div class="collection-group">
                  ...
                  <div class="collection-item" v-for="(collection, i) in contracts" :key="i"
                    :class="createForm.contract == i ? 'active' : ''" @click="selectCollection(i)">
              ...
              <el-form-item class="production-description">
                ...
                <el-input class="production-input" :placeholder="$t('erc721.placeholder2')"
              ...
              <el-form-item :class="['production-classification', { err: errorForm.category }]">
                ...
                <el-select class="classification-select" v-model="createForm.category"
              ...
              <el-form-item :class="['production-royalties', { err: errorForm.royalties }]">
                ...
                <el-input class="production-input" placeholder="10" type="number" :min="0"
                ...
                <div class="pre-box-inner">
                  ...
                  <div class="descript">
                    <div class="d">
                      <div class="d-left">
                        <div class="avatar">
                          <avatar class="bflex cpointer" :imageUrl="$filters.fullImageUrl(user.avatar)"
                            :address="user.coinbase" :imgHeight="18" :imgWidth="18" shape="circular">
                          </avatar>
                        </div>
      ...
      this.$api("user.listcontract", data).then((res) => {
        if (this.$tools.checkResponse(res)) {
          ...
          this.contracts = res.data.filter(function (contract) {
            console.log(`isSync: ${contract.isSync}, time: ${now - contract.createTime}`)
