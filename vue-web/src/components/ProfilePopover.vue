        ...
        <div class="profile-header">
          <div class="f3left">
            ...
            <div class="cpointer c6">
              ...
              <span class="el-icon-copy-document m-left-5" v-clipboard:copy="user.coinbase"
          ...
          <div class="f1right">
            <avatar @click="goItems" class="cpointer avatar-img" :imageUrl="$filters.fullImageUrl(user.avatar)"
              :address="user.coinbase" :imgWidth="40" :imgHeight="40">
            </avatar>
          </div>
        </div>

        <div class="paytoken-item" v-if="defaultPaytoken">
          <!-- <avatar class="paytoken-img" :imageUrl="$filters.fullImageUrl(defaultPaytoken.avatar)"
            :address="defaultPaytoken.address" :imgWidth="35" :imgHeight="35"></avatar> -->
            <el-avatar shape="square" :size="35" :fit="cover" :src="$filters.fullImageUrl(defaultPaytoken.avatar)" />
          <div class="m-left-10">
